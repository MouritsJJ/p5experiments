...
class GAN:
    def __init__(self, labels, epochs=100, batch_size=64, input_layer_size_g=100,
                 hidden_layer_size_g=128, hidden_layer_size_d=128, learning_rate=1e-3,
                 decay_rate=1e-4, image_size=64, display_epochs=5, create_gif=True):
        """
