...
class Generator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(ngf * 16 + 1, ngf * 12, 3, 1, 0, bias=False),
            ...
            nn.ConvTranspose2d( ngf * 2, 96, 17, 1, 0, bias=False),
            nn.BatchNorm2d(96),
            nn.ReLU(True),

            nn.ConvTranspose2d( 96, ngf, 17, 1, 0, bias=False),
            nn.BatchNorm2d(ngf),
            nn.ReLU(True),
            ...
            nn.ConvTranspose2d(32, 16, 1, 1, 0, bias=False),
            nn.BatchNorm2d(16),
            nn.ReLU(True),
            
            nn.ConvTranspose2d( 16, nc, 3, 1, 1, bias=False),
            nn.Tanh()
        )
